...
public class BookSourceMap extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_source_map);
        setUpMapIfNeeded();

        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(SRILANKA.getCenter(), 8));

        SharedPreferences settings = getApplicationContext().getSharedPreferences("BookLocation", 0);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), PassengerBOOKING.class);
                //i.putExtras(b);
    ...
    public class GetAddressTask extends AsyncTask<LatLng, String, Integer> {
        ...
        protected Integer doInBackground(LatLng... params) {
            ...
            Geocoder geoCoder = new Geocoder(BookSourceMap.this, Locale.getDefault());
            try {
